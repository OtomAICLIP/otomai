...
internal class SocketAwaitableEventArgs : SocketAsyncEventArgs, IValueTaskSource<int>
{
    ...
    protected SocketAwaitableEventArgs(PipeScheduler ioScheduler) : base(true)
    {
    ...
    protected override void OnCompleted(SocketAsyncEventArgs _)
    {
        ...
        if (c is not null || (c = Interlocked.CompareExchange(ref _continuation, _continuationCompleted, null)) is not null)
        {
