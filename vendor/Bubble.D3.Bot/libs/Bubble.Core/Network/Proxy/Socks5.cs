...
public static class Socks5
{
    ...
    public static async Task<Socket> ConnectSocket(Socket socket, Socks5Options options)
    {
        if (options == null)
            throw new ArgumentNullException(nameof(options));
    ...
    public static async Task SelectAuth(Socket socket, Socks5Options options)
    {
        /*
        +----+----------+----------+
    ...
    public static async Task Connect(Socket socket, Socks5Options options)
    {
        /*
        +-----+-----+-------+------+----------+----------+
